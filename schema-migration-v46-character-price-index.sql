-- Migration v46: keep rarity and character indexes complete when TCGPlayer
-- market price is unavailable but the provider market average is present.
-- Idempotent: replaces the summary refresh function and refreshes existing rows.
