...
export const ALL_SETS_EXTRA: ExtraSet[] = [
  ...
  {slug:'op15',code:'OP15',name:"Adventure on Kami's Island -EB04",year:2025,color:'#F472B6',price:1960,chg7d:9.1,up:true},
